"""Replay a saved CSR Transformer ranker model artifact."""
...
def main() -> None:
    ...
    parser.add_argument("--out", default="runs/phase1_csr_transformer_model_replay")
    ...
    paths = {
        "predictions": output / "csr_transformer_model_replay_predictions.jsonl",
        "comparison": output / "csr_transformer_model_replay_comparison.jsonl",
        "summary": output / "csr_transformer_model_replay_summary.json",
        "schema": output / "csr_transformer_model_replay_schema.json",
        "report": output / "csr_transformer_model_replay_report.md",
    ...
    write_manifest(
        build_artifact_manifest(
            artifact_kind="csr_transformer_model_replay",
            command="scripts/tss_csr_transformer_model_replay.py",
            tracked_files=CORE_CSR_TRANSFORMER_MODEL_REPLAY_PROVENANCE_FILES,
            metadata={
