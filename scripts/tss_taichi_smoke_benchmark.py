"""Run the real Taichi GPU smoke benchmark."""
...
from transsolvestack.profiling.taichi_benchmark import TaichiSmokeBenchmarkRunner
...
def main() -> None:
    ...
    parser.add_argument("--out", default="runs/phase1_smoke_taichi")
    ...
    runner = TaichiSmokeBenchmarkRunner(device_memory_gb=args.device_memory_gb)
    paths = runner.run(workload, candidate_set, budget, args.out)
